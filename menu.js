...
class Menu 
{
	...
	updateMenu()
	{
		document.getElementById("pizza").innerHTML = "<span class=boldText>" + this.menuItems[0].getName() + "</span>" + "<br>Price: &#8377" + this.menuItems[0].getPrice() + "<br>" + this.menuItems[0].getDescription();
		document.getElementById("pizzaAmount").innerHTML = "Amount: " + this.menuItems[0].getAmount();
		document.getElementById("burger").innerHTML = "<span class=boldText>" + this.menuItems[1].getName() + "</span>" + "<br>Price: &#8377" + this.menuItems[1].getPrice() + "<br>" + this.menuItems[1].getDescription();
		document.getElementById("burgerAmount").innerHTML = "Amount: " + this.menuItems[1].getAmount();
		document.getElementById("hotDog").innerHTML = "<span class=boldText>" + this.menuItems[2].getName() + "</span>" + "<br>Price: &#8377" + this.menuItems[2].getPrice() + "<br>" + this.menuItems[2].getDescription();
		document.getElementById("hotDogAmount").innerHTML = "Amount: " + this.menuItems[2].getAmount();
		document.getElementById("soup").innerHTML = "<span class=boldText>" + this.menuItems[3].getName() + "</span>" + "<br>Price: &#8377" + this.menuItems[3].getPrice() + "<br>" + this.menuItems[3].getDescription();
		document.getElementById("soupAmount").innerHTML = "Amount: " + this.menuItems[3].getAmount();
		document.getElementById("steak").innerHTML = "<span class=boldText>" + this.menuItems[4].getName() + "</span>" + "<br>Price: &#8377" + this.menuItems[4].getPrice() + "<br>" + this.menuItems[4].getDescription();
		document.getElementById("steakAmount").innerHTML = "Amount: " + this.menuItems[4].getAmount();
		document.getElementById("pie").innerHTML = "<span class=boldText>" + this.menuItems[5].getName() + "</span>" + "<br>Price: &#8377" + this.menuItems[5].getPrice() + "<br>" + this.menuItems[5].getDescription();
...
class CustomerLogin
{
    constructor()
    {
		...
		[
			new CustomerAccount('marty@mailinator.com', 'pswd', '120 4th St., St. Thomas, CH 600 301', 1253563467239871, 'Marty', 'Fitzer'),
			new CustomerAccount('sam@mailinator.com', 'password', '824 Main Ave., St. Thomas, CH 600 301', 6453819200945918, 'Sam', 'Ondieki'),
			new CustomerAccount('gavin@mailinator.com', 'scsu', '542 Apple Lane, St. Thomas, CH 600 301', 1965917153244617, 'Gavin', 'Dutcher'),
			new CustomerAccount('cody@mailinator.com', 'huskies', '019 1 St., St. Thomas, CH 600 301', 1300772090241003, 'Cody', 'Asfeld')
		]
	}
